...
![image](/pictures/netgear-01-cve.png)
...
![image](/pictures/netgear-02-firmware-files.png)
...
![image](/pictures/netgear-03-squashfs-root.png)
...
![image](/pictures/netgear-04-home-www.png)
...
*./etc/server.pem*
![image](/pictures/netgear-05-server-pem.png)
*/etc/dropbear*
![image](/pictures/netgear-06-dropbear.png)
...
![Untitled-2026-03-09-0611](/pictures/netgear-07-busybox-shell.png)

Việc tiếp theo là mở cái webserver lên thôi: 
***# sbin/lighttpd -f etc/lighttpd.conf***
![image](/pictures/netgear-08-lighttpd.png)
